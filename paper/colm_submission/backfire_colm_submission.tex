...
method. No verifier-free gate reaches it: neither a plurality-agreement gate
nor a token-entropy gate moves accuracy more than 0.002 from fixed-budget
voting at $N=64$. The mechanism is direct:
...
for it. High self-consistency is therefore confidently wrong about as often as
